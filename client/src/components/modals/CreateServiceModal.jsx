...
export const CreateServiceModal = ({service, setServices}) => {
            ...
            >
              ...
              >
                ...
                <header id="header-3a" className="flex items-center gap-5">
                  <h3 className="flex-1 text-xl font-bold">Crear servicio</h3>
                  <button
                ...
                {/* FORMULARIO */}
                <CreateServiceForm service={service} setServices={setServices}></CreateServiceForm>
              </div>
            </div>,
            document.body
          )
