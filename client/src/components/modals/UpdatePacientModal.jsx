...
import { UpdatePacientForm } from "../forms/UpdatePacientForm";

export const UpdatePacientModal = ({ pacient, setPacient }) => {
  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-10 items-center justify-center gap-2 justify-self-center whitespace-nowrap rounded bg-cyan-50 px-5 text-sm font-medium tracking-wide text-cyan-500 transition duration-300 hover:bg-cyan-100 hover:text-cyan-600 focus:bg-cyan-200 focus:text-cyan-700 focus-visible:outline-none disabled:cursor-not-allowed disabled:border-cyan-300 disabled:bg-cyan-100 disabled:text-cyan-400 disabled:shadow-none"
      >
        <svg
            ...
            >
              ...
              >
                ...
                <header id="header-3a" className="flex items-center gap-5">
                  <h3 className="flex-1 text-xl font-bold">Editar datos</h3>
                  <button
                ...
                {/* FORMULARIO */}
                <UpdatePacientForm pacient={pacient} setPacient={setPacient}></UpdatePacientForm>
              </div>
            </div>,
            document.body
          )
