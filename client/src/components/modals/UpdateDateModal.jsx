...
import { UpdateDateForm } from "../forms/UpdateDateForm";

export const UpdateDateModal = ({date, updateDate}) => {
  ...
  return (
    <>
      <button
        ...
        className="inline-flex px-3 h-8 items-center justify-center gap-2 self-center whitespace-nowrap rounded text-xs font-medium tracking-wide text-cyan-500"
      >
            ...
            >
              ...
              >
                ...
                <header id="header-3a" className="flex items-center gap-5">
                  <h3 className="flex-1 text-xl font-bold">Editar cita #{date.id} de {date.nombre_paciente}</h3>
                  <button
                ...
                {/* FORMULARIO */}
                <UpdateDateForm date={date} updateDate={updateDate}></UpdateDateForm>
              </div>
            </div>,
            document.body
          )
