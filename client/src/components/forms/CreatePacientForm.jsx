...
export const CreatePacientForm = ({ setPacients }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    axios
      ...
      .then((response) => {
        if (
          ...
          setShowError(null);
          setShowSuccess(`Se ha dado de alta al paciente corectamente`);
          setPacients((prev) => [...prev, response.data]);
        } else {
          setShowSuccess(null);
